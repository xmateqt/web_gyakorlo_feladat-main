...
Route::get('/new-real-estate', [App\Http\Controllers\HomeController::class, 'newRealEstate'] );

Route::post('/add-real-estate', [App\Http\Controllers\HomeController::class, 'addRealEstate'] );
